...
TOPOL = [f"../08-metadyn/metadyn_{i}/metadyn_prot.tpr" for i in range(nReplicas)]
TRAJ = [f"../08-metadyn/metadyn_{i}/metadyn_prot_pbc.trr" for i in range(nReplicas)]
WEIGHTS = [f"../09-reweight/reweight_{i}/plumed-reweight-CV.out" for i in range(nReplicas)]
