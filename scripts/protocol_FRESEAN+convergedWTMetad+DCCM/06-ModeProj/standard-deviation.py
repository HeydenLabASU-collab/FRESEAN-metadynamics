...
print(f'Standard Deviation of Mode 7 Displacement Projection: {range_mode7:.9f} nm')
print(f'Standard Deviation of Mode 8 Displacement Projection: {range_mode8:.9f} nm')
